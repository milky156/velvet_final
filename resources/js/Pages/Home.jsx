      ...
      <section className="mx-auto mt-10 max-w-7xl px-6">
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-pink-200 bg-white p-6 shadow-sm">
            <h3 className="text-2xl font-bold text-pink-700">Why custom hand picked flower?</h3>
            <p className="mt-3 text-pink-600">
              Each bloom receives soft laughter, secret glances, and love that lingers forever.
            </p>
            <button className="mt-4 rounded-full bg-pink-700 px-5 py-2 text-white hover:bg-pink-800">Personalized Bouquet</button>
          </div>
          <div className="rounded-2xl border border-pink-200 bg-white p-6 shadow-sm">
            <h3 className="text-2xl font-bold text-pink-700">Blooms recalls the one you love</h3>
            <p className="mt-3 text-pink-600">Elegant blooms that speak to the soul. Crafted to warm the heart.</p>
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-xl bg-pink-50 p-4 text-center">
                <p className="text-3xl font-bold text-pink-700">160K</p>
                <p className="text-xs text-pink-500">Bouquet Delivered</p>
              </div>
              <div className="rounded-xl bg-pink-100 p-4 text-center">
                <p className="text-base font-semibold text-pink-700">Love at First Bloom</p>
                <p className="text-xs text-pink-500">Order Now</p>
              </div>
            </div>
          </div>
        </div>
